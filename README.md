...
| 19/09/2024 (Quinta) | Migração Azure Parte 1                                | Entender como migrar aplicações e serviços da AWS para o Microsoft Azure.                               | AWS, Azure                                                | 1h20          |
| 20/09/2024 (Sexta)  | Migração Azure Parte 2                                | Continuar a migração de serviços para o Azure, focando em práticas recomendadas e desafios comuns.      | AWS, Azure                                                | 1h20          |
| 23/09/2024 (Segunda)| Migração Azure Parte 3                                | Finalizar a migração para o Azure, garantindo que todos os serviços estejam funcionando corretamente.   | AWS, Azure                                                | 1h20          |
| 24/09/2024 (Terça)  | Projeto Completo Azure                                | Implementar um projeto completo na Azure, integrando os serviços migrados.                              | AWS, Azure                                                | 1h20          |
| 26/09/2024 (Quinta) | Migração GCP Parte 1                                  | Entender como migrar aplicações e serviços da AWS para o Google Cloud Platform (GCP).                   | AWS, Google Cloud Platform (GCP)                          | 1h20          |
| 27/09/2024 (Sexta)  | Migração GCP Parte 2                                  | Continuar a migração de serviços para o GCP, focando em práticas recomendadas e desafios comuns.        | AWS, Google Cloud Platform (GCP)                          | 1h20          |
| 30/09/2024 (Segunda)| Migração GCP Parte 3                                  | Finalizar a migração para o GCP, garantindo que todos os serviços estejam funcionando corretamente.     | AWS, Google Cloud Platform (GCP)                          | 1h20          |
| 01/10/2024 (Terça)  | Projeto Completo GCP                                  | Implementar um projeto completo no GCP, integrando os serviços migrados.                                | AWS, Google Cloud Platform (GCP)                          | 1h20          |
